...
# parse command args
try:
    opts, args = getopt.getopt(sys.argv[1:], "", ["nu=", "kappa=", "g=", "D=",
                               "Tbot=", "Ttop=", "T0=",
                               "Lx=", "Lz=", "tstop=", "twall-stop=", 
                               "nx=", "nz=", "dir-str=", "help"])
...
# setup equations & BCs
flame = equations.Flame(domain)
pde = flame.set_problem(nu, kappa, D, g, T0, Tbot, Ttop)
