...
# Options
fnames = ["u","w", "T", "c"]
vertical_stack = False   # grid of Nx x 1 or 1 x Ny
square_stack = True      # grid of Nx x Ny

if square_stack:
   ncols = 2    # for a true 2D grid of images, set rows & cols
   nrows = 2
...
#             ('RdYlBu', 'diverging', 11), ('BuPu', 'sequential', 9)]
color_map = [('RdYlBu', 'diverging', 11), ('RdYlBu', 'diverging', 11), 
             ('RdYlBu', 'diverging', 11), ('RdYlBu', 'diverging', 11)]
...
# Determine grid size
if square_stack:
    pass  # rows & cols should already be set
else:
    if vertical_stack:
      nrows = len(fields)
      ncols = 1
